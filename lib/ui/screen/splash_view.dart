...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Responsive(
        mobView: HeroProfileWithRipple(
          assetImage: AssetImage(AssetsImages.mobProfile),
        ),
        tabView: HeroProfileWithRipple(
          assetImage: AssetImage(AssetsImages.webProfile),
        ),
        desView: HeroProfileWithRipple(
          assetImage: AssetImage(AssetsImages.webProfile),
        ),
      ),
    );
